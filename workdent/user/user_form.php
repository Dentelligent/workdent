...
$conn->query("SET time_zone = '+05:30'");
    ...
    $sql = "INSERT INTO executives (ClinicName, DoctorName, Service,  ExecutiveName, Area, Caseid, Remarks, latitude, longitude, Photo) 
...
<div class="" id="main">
    <div id="nav-bg" class="container-fluid">
        <div class="row">
            <div class="col-lg-10 ">
                <H2 style='padding:20px;color:yellow'>WORKDENT</H2>
            </div>
            <div class="col-lg-2">
                ...
                <span style="text-align: left; padding:20px;">
                    <img src="../images/logo.jpeg" alt="Your Image" width="80px" style="border-radius:10%">
    ...
    <div class="container">
    <h2 class="mt-5 mb-4">ADD EXECUTIVE REPORTS</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                ...
                <select class="form-select" id="service" name="service" required>
                    ...
                    <option value="ios visit">ORAL SCAN VISIT</option>
                </select>
            </div>
        </div>
